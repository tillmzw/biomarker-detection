...
if __name__ == "__main__":
    ...
    if args.validate:
        ...
        acc, loss, avg_precision, confusion, prc, roc = validate(net, testloader, record_filename=mmr)
        ...
        implot = utils.plot_to_pil(plot)
        if args.scratch:
            utils.save_pil_to_scratch(implot, target_dir=args.scratch, name="final_roc-auc.png", overwrite=True)
        wandb.log({"roc_auc": wandb.Image(implot)})
